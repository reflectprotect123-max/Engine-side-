...
for f in app.js engine.js session.js library.js library-ui.js timer.js logger.js native-bridge.js adaptive-bundle.js brain-bundle.js service-worker.js PRODUCT.json home.css logger.css library.css; do
  cp "$ROOT/$f" "$DEST/"
done
